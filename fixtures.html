...
- **API JSON**: when adding contract tests, keep fixture responses under `fixtures/api/` (e.g., `verse_1_1.json`, `morph_1_1.json`, `dep_1_1.json`).
- **UI E2E (Tauri)**: run the native app via WebDriver (`npm run test:e2e`) and avoid mocks so commands exercise real data.
